...
module.exports.run = async (bot, message, args) => {
    ...
    if (!message.member.hasPermissions ('KICK_MEMBERS')) return message.channel.send("You need to have permission: `KICK_MEMBERS`!")
    ...
    if (!reason) return message.channel.send('Please specify a reason of mute!')
